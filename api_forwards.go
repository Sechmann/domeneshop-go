...
*/
func (a *ForwardsApiService) DomainsDomainIdForwardsHostDelete(ctx _context.Context, domainId int32, host string) (*_nethttp.Response, error) {
	var (
